...
public class MySoapMessageFactory implements SoapMessageFactory,
		InitializingBean {
	// This is the Request Context Attribute.
	private static final String REQUEST_CONTEXT_ATTRIBUTE = "MySoapMessageFactory";

	private static final Log logger = LogFactory
			.getLog(MySoapMessageFactory.class);
