...
/**
 * UsrGrpGrpLgId generated by hbm2java
 */
@Embeddable
public class UsrGrpGrpLgId  implements java.io.Serializable {


     private int idLg;
     private Date ts;

    public UsrGrpGrpLgId() {
    }

    public UsrGrpGrpLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UsrGrpGrpLgId) ) return false;
		 UsrGrpGrpLgId castOther = ( UsrGrpGrpLgId ) other; 
