...
/**
 * UsrLgId generated by hbm2java
 */
@Embeddable
public class UsrLgId  implements java.io.Serializable {
    ...
    public UsrLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UsrLgId) ) return false;
		 UsrLgId castOther = ( UsrLgId ) other; 
