...
public class EntityValues  implements java.io.Serializable {
    ...
    public EntityValues(EntityValuesId id, EntitySpec entitySpec, Tuple tuple, ModelDataUpdate modelDataUpdate, double value) {
       this.id = id;
    ...
    public EntityValuesId getId() {
        return this.id;
    }
    
    public void setId(EntityValuesId id) {
        this.id = id;
    }
