...
/**
 * UsrGrpLgId generated by hbm2java
 */
@Embeddable
public class UsrGrpLgId  implements java.io.Serializable {
    ...
    public UsrGrpLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UsrGrpLgId) ) return false;
		 UsrGrpLgId castOther = ( UsrGrpLgId ) other; 
