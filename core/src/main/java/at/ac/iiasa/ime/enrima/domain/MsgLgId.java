...
/**
 * MsgLgId generated by hbm2java
 */
@Embeddable
public class MsgLgId  implements java.io.Serializable {
    ...
    public MsgLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MsgLgId) ) return false;
		 MsgLgId castOther = ( MsgLgId ) other; 
