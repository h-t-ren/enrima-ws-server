...
/**
 * AthntctnUsrLgId generated by hbm2java
 */
@Embeddable
public class AthntctnUsrLgId  implements java.io.Serializable {


     private int idLg;
     private Date ts;

    public AthntctnUsrLgId() {
    }

    public AthntctnUsrLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AthntctnUsrLgId) ) return false;
		 AthntctnUsrLgId castOther = ( AthntctnUsrLgId ) other; 
