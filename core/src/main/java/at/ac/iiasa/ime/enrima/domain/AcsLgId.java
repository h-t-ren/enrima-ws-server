...
/**
 * AcsLgId generated by hbm2java
 */
@Embeddable
public class AcsLgId  implements java.io.Serializable {
    ...
    public AcsLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AcsLgId) ) return false;
		 AcsLgId castOther = ( AcsLgId ) other; 
