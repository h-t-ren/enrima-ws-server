...
/**
 * LblLgId generated by hbm2java
 */
@Embeddable
public class LblLgId  implements java.io.Serializable {
    ...
    public LblLgId(int idLg, Date ts) {
       this.idLg = idLg;
       this.ts = ts;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LblLgId) ) return false;
		 LblLgId castOther = ( LblLgId ) other; 
